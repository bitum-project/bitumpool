...
var (
	...
	defaultHomeDir    = bitumutil.AppDataDir("miner", false)
...
type config struct {
	...
	Pool       string `long:"pool" description:"The stratum domain and port of the mining pool to connect to. eg. bitumpool.com:4445"`
...
func loadConfig() (*config, []string, error) {
	...
	// Update the home directory for bitumpcclient if specified. Since the home
